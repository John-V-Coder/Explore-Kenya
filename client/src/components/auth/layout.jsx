...
function AuthLayout() {
  const [showAuthForm, setShowAuthForm] = useState(true); // Changed to true by default
  ...
  const handleSignUpClick = (categoryTitle) => {
    ...
    // Scroll to top to show auth form
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        {/* Auth Form Section - Now at the top */}
        {showAuthForm && (
        ...
        {/* Hero Section - Only show when auth form is closed */}
        {!showAuthForm && (
        ...
        {/* Categories Section - Only show when auth form is closed */}
        {!showAuthForm && (
          <section className="mb-12 grid md:grid-cols-2 gap-6">
            {categories.map((category) => (
              <div key={category.id} className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="p-4">
                  ...
                  <button
                    ...
                    className="w-full bg-white border border-gray-300 py-2 rounded text-sm hover:bg-gray-100 transition-colors"
                  >
                    Request Catalog
                  </button>
                </div>
        ...
        {/* About Section - Only show when auth form is closed */}
        {!showAuthForm && (
        ...
        {/* Team Section - Only show when auth form is closed */}
        {!showAuthForm && (
